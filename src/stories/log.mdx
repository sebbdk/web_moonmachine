...
**Scene status / stuff i'm working on:**
 - Scene 1-10 interactions
	...
	- <span style="color: green">Scene 8 - done</span>
		- <span style="color: green">The background city light animations only show when debug is enabled</span>
		- <span style="color: green">There is a playSound error in terminal when scene is run</span>
